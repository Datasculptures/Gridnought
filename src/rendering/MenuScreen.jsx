 ...
 */
export default function MenuScreen({ gameState, onResume, onStart, onStartMech, onQuit, onHowTo }) {
  ...
  return (
    ...
    >
      ...
      <div style={{ height: 10 }} />
      <button className="wireframe-btn" onClick={onStartMech}>START AS MECH</button>
      <div style={{ height: 10 }} />
      ...
      <div style={{ color: '#006600', fontSize: 10, lineHeight: 1.7, marginTop: 26, letterSpacing: 1, textAlign: 'center' }}>
        ...
        <div>1 / 2 / 3 — MG · HE · AP AMMO&nbsp;&nbsp;&nbsp;X — DRONE STRIKE&nbsp;&nbsp;&nbsp;P — TOGGLE VIEW</div>
        <div>R — RETASK DRONE&nbsp;&nbsp;&nbsp;ESC — PAUSE</div>
      </div>
    </div>
  );
}
